...
export class AuthService {
  ...
  async refresh(refreshStr: string): Promise<
    | {
  ...
  private retrieveRefreshToken(refreshStr: string): Promise<refresh_tokens | undefined> {
    try {
      const decoded = this.jwt.verify(refreshStr, {
